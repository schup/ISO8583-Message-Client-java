...
class ByteArrayTest {
    ...
    void testAppendByteArray() {
        ...
        assertThat(byteArray.toString()).isEqualTo("Hello");
        ...
        assertThat(byteArray.toString()).isEqualTo("Hello World");
    }
    ...
    void testMethodChaining() {
        ...
        assertThat(byteArray.toString()).isEqualTo("Start Hello World");
